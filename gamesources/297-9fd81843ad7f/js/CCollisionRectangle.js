...
function CCollisionRectangle(oSprite, iStartX, iStartY, iRegX, iRegY, iRotation){
    var _oBox;
    ...
    this.init = function() {        
        ...
        _aPoints.push(new createjs.Point( _oSprite.width-_iRegX- iToleranceX, -_iRegY+ iToleranceY));                   //top right
        _aPoints.push(new createjs.Point( _oSprite.width-_iRegX- iToleranceX, _oSprite.height-_iRegY- iToleranceY));    //bottom right
        _aPoints.push(new createjs.Point( -_iRegX+ iToleranceX, _oSprite.height-_iRegY- iToleranceY));                  //bottom left
